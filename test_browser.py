...
class test_browser(unittest.TestCase):
    ...
    def test_friendList(self):
        ...
        dl = new_browser()
        dl.login('test', 'test')
        test_data = {'240303471': 0, '446766202': 1, '500275848': 2, '444024948': 20, '384065413': 21, '397529849': 22,
                     '739807017': 40}
    ...
    def test_status(self):
        dl = new_browser()
        dl.login('test', 'test')
        test_data = {'446766202': 0, '500275848': 1, '104062077': 2, '232877604': 20, '242641331': 21, '256137627': 22,
                     '411984911': 40}
        for rid, expt in test_data.items():
    ...
    def test_iter_page(self):
        ...
        friendList = {'240303471': 0, '446766202': 1, '500275848': 2, '444024948': 20, '384065413': 21, '397529849': 22,
                      '739807017': 40}
        status = {'446766202': 0, '500275848': 1, '104062077': 2, '232877604': 20, '242641331': 21, '256137627': 22,
                  '411984911': 40}
    ...
    def test_new_browser(self):
        ...
        self.assertTrue(
            isinstance(dl._download('http://friend.renren.com/GetFriendList.do?curpage=0&id=240303471'), str))
        self.assertEquals(len(request_time), 1)
