...
class spider:
    ...
    def getNet2(self, orig_id='410941086'):
        ...
        print('{} get net2 of {},toSearch/total:{}/{}'.format(time.strftime('%H:%M:%S', time.localtime()), orig_id,
                                                              len(toSearch), len(friends)))
    ...
    def getStatus_friend(self, orig_id='410941086'):
        ...
        print('{} {} of {},toSearch/total:{}/{}'.format(time.strftime('%H:%M:%S', time.localtime()), 'friends\' status',
                                                        orig_id, len(toSearch), len(friends) + 1))
        self.seq_process(toSearch, pageStyle)
    ...
    def getProfile_friend(self, orig_id='410941086'):
        ...
        toSearch = (friends | {orig_id}) - self.searched[pageStyle]
        print(
            '{} {} of {},toSearch/total:{}/{}'.format(time.strftime('%H:%M:%S', time.localtime()), 'friends\' profile',
                                                      orig_id, len(toSearch), len(friends) + 1))
        self.seq_process(toSearch, pageStyle)

    def getAllAlbum_friend(self, target_id='386451741'):
        pass
    ...
    def seq_process(self, toSearch, pageStyle):
        ...
        for i, rid in zip(range(1, len(toSearch) + 1), toSearch):
            ...
            if record is None:
                ...
                log_text = '{}/{},saved/download:{}/{},{} of {}, time={}'.format(i, len(toSearch), n, len(record),
                                                                                 pageStyle, rid, run_info)
